...
coded by myself.</i></span>
    ...
    <div className="card my-2">
        ...
        <div className="d-flex mobile-projects">
            ...
            </div><div className="alert alert-danger mx-1 no-wrap"><span> Source Code : <b>Sold out</b></span></div>
            </div>
        </div>
    </div>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#4</span> Chatting App</b></span>
...
chatting with SocketIO,saving all chatting data on MongoDB</i></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#5</span>Multi Product Auction App</b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#6</span> DOCX to PDF Convert App </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#7</span> Crypto Currency Tracking App </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#8</span> Form Builder Drag and Drop </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#9</span> Weather App With Geo Location  </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#10</span> PSD to React App </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#11</span> React Notes App </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#12</span> Rock, Paper ,Scissors React Game </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#13</span> React Book Search App </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#14</span> BMI Calculator </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#15</span> Pokemon Match Game </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-other mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-info sort-alert">#16</span> Face Recognition Payment System</b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-other mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-info sort-alert">#17</span> Detecting Electronic Card Issues</b></span>
