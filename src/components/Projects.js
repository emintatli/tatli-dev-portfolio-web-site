...
coded by myself.</i></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#3</span> Chatting App</b></span>
...
chatting with SocketIO,saving all chatting data on MongoDB</i></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#10</span> React Book Search App </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#11</span> BMI Calculator </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-front mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-success sort-alert">#12</span> Pokemon Match Game </b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-other mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-info sort-alert">#13</span> Face Recognition Payment System</b></span>
    ...
    <div className="card my-2">
        <div className="card-body d-flex align-items-center justify-content-between back-other mobile-projects">
            <span className="text-dark w-50 me-3"><b><span className="alert alert-info sort-alert">#14</span> Detecting Electronic Card Issues</b></span>
